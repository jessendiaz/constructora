...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblpuertanorte (strimagen, strdescripcion, intestado) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "puerta_norte_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="container">
  ...
  function subirimagen(){
    ...
    <h1>A&ntilde;adir Imagen Puerta Norte</h1>
    <p>&nbsp;</p>
