...
$query_datosslider = "SELECT * FROM tblslider ORDER BY idContador ASC";
...
<div class="container">
  ...
  function asegurar(){
    ...
    <h1>Lista de imagenes en slider</h1>
    <p><a href="slider_add.php"><img src="../iconos/agregar.png" width="16" height="16" />Añadir imagen</a></p>
    <p>&nbsp; </p>
    <table width="100%" border="0" cellpadding="2" cellspacing="2">
      ...
      <?php do { ?>
  <tr>
    <td><p><img src="../documentos/img_slider/<?php echo $row_datosslider['strImagen']; ?>" width="300" height="119" /></p>
      <p></p></td>
    <td><?php echo $row_datosslider['strDescripcion']; ?></td>
    <td><?php 
	if( $row_datosslider['intEstado']==1)echo "ACTIVO";
	else echo"INACTIVO";?></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="slider_edit.php?recordID=<?php echo $row_datosslider['idContador']; ?>"><img src="../iconos/editar32.png" width="32" height="32" /></a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="slider_remove.php?recordID=<?php echo $row_datosslider['idContador']; ?>"><img src="../iconos/eliminar.png" width="32" height="32" onclick="javascript:return asegurar();" /></a></td>
  </tr>
