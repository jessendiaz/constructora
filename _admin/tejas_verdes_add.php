...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbltejasverdes (strimagen, strdescripcion, `intestado`) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "tejas_verdes_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$totalRows_datotejasverdes = mysql_num_rows($datotejasverdes);mysql_select_db($database_conexionconstructora, $conexionconstructora);
$query_datotejasverdes = "SELECT * FROM tbltejasverdes";
$datotejasverdes = mysql_query($query_datotejasverdes, $conexionconstructora) or die(mysql_error());
$row_datotejasverdes = mysql_fetch_assoc($datotejasverdes);
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td width="302"><input type="text" name="strimagen" value="" size="32" /><input type="button" name="button" id="button" value="Examinar" onclick="javascript:subirimagen();"/></td>
        </tr>
        <tr valign="baseline">
