    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td width="285"><input type="text" name="strImagen" value="" size="32" />
          <input type="button" name="button" id="button" value="Examinar" onclick="javascript:subirimagen();"/></td><td width="10"></td>
        </tr>
        <tr valign="baseline">
